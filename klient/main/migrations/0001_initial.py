# Generated by Django 3.2.9 on 2021-12-11 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_status', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'db_table': 'auto',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo_status', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'db_table': 'cargo',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'db_table': 'delivery',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage_status', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'db_table': 'storage',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trailer_status', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'db_table': 'trailer',
                'managed': False,
